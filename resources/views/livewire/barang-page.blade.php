<div class="max-w-5xl mx-auto">
    ...
    {{-- Search --}}
    <div class="mb-4">
        <input wire:model.live="search" type="text" placeholder="Cari barang..."
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="text-left px-4 py-3 text-xs uppercase tracking-widest font-medium text-gray-500">Nama</th>
                    <th class="text-left px-4 py-3 text-xs uppercase tracking-widest font-medium text-gray-500">Kategori</th>
                    <th class="text-left px-4 py-3 text-xs uppercase tracking-widest font-medium text-gray-500">Harga</th>
                    <th class="text-left px-4 py-3 text-xs uppercase tracking-widest font-medium text-gray-500">Unit</th>
                    <th class="text-left px-4 py-3 text-xs uppercase tracking-widest font-medium text-gray-500">Aksi</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 flex items-center gap-2">
                            ...
                            <button wire:click="showDeleteConfirm('{{ $barang['id_barang'] ?? '' }}')"
                                class="border border-black p-1 hover:bg-black hover:text-white transition"
                                title="Hapus">
    ...
    @if($showDeleteModal)
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div class="bg-white w-full max-w-sm p-6 shadow-lg text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-auto mb-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                          d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M1 7h22M8 7V5a2 2 0 012-2h4a2 2 0 012 2v2"/>
                </svg>
                <h2 class="text-sm font-bold uppercase tracking-widest mb-2">Hapus Barang</h2>
                <p class="text-sm text-gray-500 mb-6">Apakah kamu yakin ingin menghapus barang ini? Tindakan ini tidak bisa dibatalkan.</p>
